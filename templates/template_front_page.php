...
<?php
get_header();
include TEMPLATEPATH . '/include/ipg_slider.php';
?>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="maps-and-data">
                        ...
                        <ul class="maps-and-data-list">
                            ...
                            <li>
                                <a href="publications.html"><span class="fa fa-map-marker"></span>
                        ...
                        <ul class="recent-posts">
                            ...
                            <?php if ($the_query->have_posts()) : ?>
                                <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
                                    ...
                                    <li class="recent-posts-item bg-white rounded ml-3 p-2 shadow on-hover">
...
<h1>Hello world</h1>
    ...
    <!-- Earthquake Section -->
    <section class="pt-5 bg-light" style="margin-bottom: 1px;">
        <div class="white">
            ...
            <input type="hidden" id="earthquake_url" value="<?php get_earthquake_setting('earthquake_url'); ?>">
            <input type="hidden" id="earthquake_radius" value="<?php get_earthquake_setting('earthquake_radius'); ?>">
            <div class="earthquake_container" id="earthquake_container">
                <div class="row">
                    <div class="col-md-3">
                        <ol id="most-recent-earthquake-list" class="list-numbers mb-0 ml-2">
